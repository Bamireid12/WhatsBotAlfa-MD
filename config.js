...
module.exports = {
  ...
  //------------------------------------------------------------------------------------------------
  PACKNAME:  process.env.PACKNAME                               || "B∆mireid" ,
  //------------------------------------------------------------------------------------------------
  WELCOME_MSG: process.env.WELCOME_MSG                          || "Hi @user Welcome to @gname",
  //------------------------------------------------------------------------------------------------
  GOODBYE_MSG: process.env.GOODBYE_MSG                          || "Hi @user It was Nice Seeing you",
  //------------------------------------------------------------------------------------------------
  AUTHOR:  process.env.AUTHOR                                   || "B∆mireid" ,
  //------------------------------------------------------------------------------------------------
  OWNER_NAME:  process.env.OWNER_NAME                           || "B∆mireid",
  //------------------------------------------------------------------------------------------------
  BOT_NAME:  process.env.BOT_NAME                               || "B∆MIREID'S WIFE🌚",
  //------------------------------------------------------------------------------------------------
